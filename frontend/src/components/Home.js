...
const Home = () => {
	...
	return (
		<div>
			...
			<div className="intro">
				<p>
					This is a <strong>full stack website</strong> that is designed for my personal usage. I spent most of 
					my time in 2020 brushing up my web development skills. I found a ton of fantastic 
